...
class Router(object):
    """ A Router is an ordered collection of route->target pairs. It is used to
        efficiently match WSGI requests against a number of controllers and return
    ...
    def __init__(self, strict=False):
        ...
        self.static = {}  # Search structure for static controllers
        self.dyna_routes = {}
        self.dyna_regexes = {}  # Search structure for dynamic controllers
        #: If true, static controllers are no longer checked first.
        ...
        for match in self.rule_syntax.finditer(rule):
            ...
            if g[2] is not None:
                depr(0, 13, "Use of old route syntax.",
                            "Use <name> instead of :name in controllers.")
...
class Bottle(object):
    """ Each Bottle object represents a single, distinct web application and
        consists of controllers, callbacks, plugins, resources and configuration.
    ...
    def mount(self, prefix, app, **options):
        """ Mount an application (:class:`Bottle` or plain WSGI) to a specific
            ...
            Plugins from the parent application are not applied to the controllers
    ...
    def merge(self, routes):
        """ Merge the controllers of another :class:`Bottle` application or a list of
            :class:`Route` objects into this application. The controllers keep their
    ...
    def install(self, plugin):
        """ Add a plugin to the list of plugins and prepare it for being
            applied to all controllers of this application. A plugin may be a simple
    ...
    def reset(self, route=None):
        """ Reset all controllers (force plugins to be re-applied) and clear all
...
class TemplatePlugin(object):
    """ This plugin applies the :func:`view` decorator to all controllers with a
...
def yieldroutes(func):
    """ Return a generator for controllers that match the signature (name, args)
